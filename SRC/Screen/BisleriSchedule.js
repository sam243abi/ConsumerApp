    ...
    <View style={styles.container}>
      <View style={styles.productContainer}>
        <Image
          ...
          source={require('./images/bisleriCan.jpg')}
        />
        <View style={styles.productDetails}>
          <Text style={styles.productTitle}>Bisleri Water Can </Text>
          <Text style={styles.productSize}>25 L</Text>
      ...
      <View style={styles.planContainer}>
        <TouchableOpacity style={styles.planButton} onPress={() => navigateTo(navigation,'Daily')}>
          <Text style={styles.planButtonText}>Daily</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.planButton} onPress={() => navigateTo(navigation,'Weekly')}>
          <Text style={styles.planButtonText}>Weekly</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.planButton} onPress={() => navigateTo(navigation,'Monthly')}>
          <Text style={styles.planButtonText}>Monthly</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.planButton} onPress={() => navigateTo(navigation,'AlternateDays')}>
