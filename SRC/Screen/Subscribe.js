...
const imageMap = {
  "./SRC/images/bisleri2.png": require("./images/bisleri2.png"),
  "./SRC/images/aquafina2.png": require("./images/aquafina2.png"),
  "./SRC/images/bluestar.png": require("./images/bluestar.png"),
  "./SRC/images/aavin2.png": require("./images/aavin2.png"),
  "./SRC/images/arokya2.png": require("./images/arokya2.png"),
...
const Subscribe = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <Text style={globalStyles.ScheConfirmButtonText}>Subscribe Now</Text>
      </TouchableOpacity>
    </View>
  );
};
