    ...
    <View style={styles.container}>
      ...
      <View style={styles.planContainer}>
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate("Daily", { product })}
        >
          <Text style={styles.planButtonText}>Daily</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.planButton}
          onPress={() => navigation.navigate("Weekly", { product })}
        >
          <Text style={styles.planButtonText}>Weekly</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.planButton}
          onPress={() => navigation.navigate("Monthly", { product })}
        >
          <Text style={styles.planButtonText}>Monthly</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.planButton}
          onPress={() => navigation.navigate("AlternateDays", { product })}
        >
