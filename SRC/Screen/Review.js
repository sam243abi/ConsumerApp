...
const { selectedPlan = 'Daily', product = ProductData.watercan[0] } = route.params || {};
      ...
      <View style={styles.buttonContainer}>
        ...
        >
          <Text
            style={[
              styles.buttonText,
              selectedPlan === 'AlternateDays' ? styles.selectedText : styles.unselectedText,
            ]}
          >
            Alternate Days
          </Text>
        ...
        <View style={styles.modalContainer}>
          ...
          <View style={styles.modalImageContainer}>
            ...
            <View style={styles.modalDetails}>
              ...
              <Text style={styles.modalText}>{selectedPlan} Plan</Text>
              <Text style={styles.modalCost}>Price: {product.price}</Text>
            </View>
          </View>
